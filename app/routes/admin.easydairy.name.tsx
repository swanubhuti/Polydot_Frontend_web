...
export const meta: MetaFunction = (request) => {
  return [
    { title: `Easy Dairy Admin - Easy Dairy Names` },
    { name: "description", content: "Easy Dairy Admin - Easy Dairy Names" },
  ];
};
...
export default function BusinessAdminEasyDairy() {
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <h3 className="md:text-2xl text-xl p-2">Easy Dairy Names</h3>
